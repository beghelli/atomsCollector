...
GameEntities::Player::Player(int x, int y)
{
	...
	this->yv = 0;
	this->zAngle = 0;
	this->acceleration = Engine::MetricManager::unitToPixels(0.007);
	this->isAcceleratingX = false;
	this->isAcceleratingY = false;
	this->entityHeight = (int) Engine::MetricManager::unitToPixelsY(0.5);
	this->entityWidth = (int) Engine::MetricManager::unitToPixelsX(0.55);
